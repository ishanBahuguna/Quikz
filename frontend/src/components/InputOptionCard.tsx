...
//             <div key={idx}>
//                 {`Option ${idx+1}`}<input type="text" placeholder='Enter option here...'
//                     onChange={(e) => setQuestion((prev) => (
//                         {...prev , [`option${idx+1}` as keyof QuizQuestionType] : e.target.value}
//                     ))}/>
//             </div>
//         ))}
//         <input type="text" placeholder='Enter correct option here' onChange={
//             (e) => setQuestion((prev) => (
...
//         >
//           {isSubmit ? "Remove Question" : "Submit Question"}
//         </button>
//       </div>
//     </div>
//   )
